...
WARNING: Rappel : ne pas utiliser les bouton de style rapide *"G"*, _"I"_, et __"S"__
...
=== Tableaux
Lors de la copie du règlement sur le fichier FODT, les bordures des tableaux ne sont
pas reportées. Il faut donc insérer des tableaux à partir de l’onglet Tableau, et
intégrer le texte dans les cellules comme dans le PDF original.
