...
. Nommer votre fichier XXXXX_reglement_YYYYYYYY.xml où XXXXX désigne le code INSEE de la commune (ou le code SIREN pour un PLUi) et YYYYYYYY la date d'enregistrement
