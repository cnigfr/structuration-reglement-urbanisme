...
Le modèle s'appuie sur les classes du [standard CNIG SRU de niveau 1](https://cnig.gouv.fr/ressources-dematerialisation-documents-d-urbanisme-a2732.html) (les deux premières "colonnes" dans le schéma UML) en l'enrichissant au niveau de la classe `Contenu`.
