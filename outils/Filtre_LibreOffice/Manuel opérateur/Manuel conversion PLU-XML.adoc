...
* Tout d'abord, il est nécessaire d'installer l'extension xslt2-transformer.

. Pour cela, il faut télécharger le fichier .oxt qui se trouve https://github.com/dtardon/xslt2-transformer/releases[ici]. 
. Puis installer l’extension dans LibreOffice :
Outils > Gestionnaire des extensions > Ajouter et sélectionner le fichier télécharger.
